		...
		if ( ! $mautic_woo->is_valid_client_id_stored() && $mautic_woo->is_setup_completed() ) {
			...
			<div class="notice notice-error is-dismissible"> 
				<p class="mauwoo-acces-token-renewal">
					<strong ><?php esc_html_e( 'You have lost the connection with Mautic. Please click the button to reauthorize with Mautic.', 'enhanced-woocommerce-mautic-integration' ); ?></strong>
					<a href= "<?php echo esc_url_raw( admin_url( 'admin.php?page=mautic-woo&mauwoo_tab=mautic-woo-connect' ) ); ?>" class="mauwoo-reauthorize-app "><?php esc_html_e( 'Reauthorize with Mautic.', 'enhanced-woocommerce-mautic-integration' ); ?><i class="fas fa-circle-notch fa-spin mauwoo-hide "></i></a>
				</p>
