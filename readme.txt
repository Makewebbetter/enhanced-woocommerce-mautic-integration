...
* [**Free Email Templates for Mautic**](https://makewebbetter.com/free-mautic-email-templates/?utm_source=MWB-mautic-org&utm_medium=MWB-org-page&utm_campaign=MWB-freemauticemailtemplates-org)

* [**Premium Email Templates for Mautic**](https://makewebbetter.com/mautic-email-templates/?utm_source=MWB-mautic-org&utm_medium=MWB-org-page&utm_campaign=MWB-mauticemailtemplates-org)
...
The manual installation method involves downloading our Integration with Mautic for WooCommerce and uploading it to your web server via your favorite FTP application. The WordPress codex contains [instructions on how to do this here](https://wordpress.org/support/article/managing-plugins/#manual-plugin-installation).
 ...
 **Please follow the steps to get rid of this:**

i) One of the “annotations” folders on Mautic should be writable in order to make custom fields. Please navigate to the folder where the Mautic has been set up and follow this path:

 **For Mautic Version 2.x**
path -to-mautic/app/cache/prod/ and make the annotation file writable. Set the permission as 777.

 **For Mautic Version 3.x**
path -to-mautic/var/cache/prod/ and make the annotation file writable. Set the permission as 777.

ii) After this, clear the Mautic cache.

There are several ways to do that. The easiest is by going to the /app/cache folder and delete its content or you can also rename the cache folder like cache_backup
...
* Added WooCommerce tag to contacts synced by the plugin
* Updated RFM logic
