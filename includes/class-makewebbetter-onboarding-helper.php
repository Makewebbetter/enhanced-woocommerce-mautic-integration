...
class Makewebbetter_Onboarding_Helper {
	...
	/**
	 * Onboarding Form id of hubspot api.
	 *
	 * @since 1.0.0
	 * @var string $onboarding_form_id Onboarding Form id.
	 */
	private static $onboarding_form_id = 'd94dcb10-c9c1-4155-a9ad-35354f2c3b52';

	/**
	 * Deactivation Form id of hubspot api.
	 *
	 * @since 1.0.0
	 * @var string $deactivation_form_id Deactivation Form id.
	 */
	private static $deactivation_form_id = '329ffc7a-0e8c-4e11-8b41-960815c31f8d';


	/**
	 * Plugin Name of hubspot api.
	 *
	 * @since 1.0.0
	 ...
	 *
	 * @since    1.0.0
	 * @return boolean - to check valid screen
	 */
	 ...
	 *
	 * @since    1.0.0
	 * @return boolean - Show Onboarding Popup
	 */
	 ...
	 *
	 * @since    1.0.0
	 * @return array - Onboarding Form Fields
	 */
	public function add_on_boarding_form_fields() {
		...
		$fields = array(
			...
			rand() => array(
				'id' => 'onboard-email',
				'label' => esc_html__( 'What is the best email address to contact you?', 'enhanced-woocommerce-mautic-integration' ),
				'type' => 'email',
				'name' => 'email',
			...
			rand() => array(
				'id' => 'onboard-number',
				'label' => esc_html__( 'What is your contact number?', 'enhanced-woocommerce-mautic-integration' ),
				'type' => 'text',
				'name' => 'phone',
				'value' => '',
				'required' => 'yes',
	 ...
	 *
	 * @since    1.0.0
	 * @return array - Deactivation Form Fields
	 */
	public function add_deactivation_form_fields() {
		...
		$fields = array(
			...
			rand() => array(
				...
				'extra-class' => '',
				'options' => array(
					'temporary-deactivation-for-debug' => esc_html__( 'It is a temporary deactivation. I am just debugging an issue.', 'enhanced-woocommerce-mautic-integration' ),
					'site-layout-broke'                => esc_html__( 'The plugin broke my layout or some functionality.', 'enhanced-woocommerce-mautic-integration' ),
					'complicated-configuration'        => esc_html__( 'The plugin is too complicated to configure.', 'enhanced-woocommerce-mautic-integration' ),
					'no-longer-need'                   => esc_html__( 'I no longer need the plugin', 'enhanced-woocommerce-mautic-integration' ),
					'found-better-plugin'              => esc_html__( 'I found a better plugin', 'enhanced-woocommerce-mautic-integration' ),
					'other'                            => esc_html__( 'Other', 'enhanced-woocommerce-mautic-integration' ),
				),
			),
			...
			case 'select2':
				...
				if ( ! empty( $options ) && is_array( $options ) ) {
					...
					<select class="on-boarding-select-field <?php echo esc_html( $select2 ); ?> <?php echo esc_html( $class ); ?>" id="<?php echo esc_html( $id ); ?>" name="<?php echo esc_html( $name ); ?>[]" <?php echo esc_html( $required ); ?> <?php echo esc_html( $is_multiple ); ?>>
						...
						<?php if ( 'select' == $type ) : ?>	
							<option class="on-boarding-options" value=""><?php esc_html_e( 'Select Any One Option...', 'enhanced-woocommerce-mautic-integration' ); ?></option>
						<?php endif; ?>
	 ...
	 * @since      1.0.0
	 * @return string - render form data into table
	 */
	public function render_form_data_into_table( $formatted_data = array() ) {

		$email_body = '<table border="1" id="render_form_data"><tr><th>Data</th><th>Value</th></tr>';
	 ...
	 * @since    1.0.0
	 * @return boolean - additional validation
	 */
	 ...
	 * @param string $action_type  The action type of this validation.
	 * @since    1.0.0
	 * @return boolean - handle form submission
	 */
	...
	/**
	 *  Hubwoo Onboarding Submission :: get_client_ip.
	 *
	 * @since       1.0.0
